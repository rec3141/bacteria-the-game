...
FILES=(index.html game.js scores.php feedback.php README.md Bacteria.swf assets
...
DRIFT=""
for f in index.html game.js scores.php feedback.php README.md manifest.webmanifest icon.svg Bacteria.swf .htaccess; do
  [ -f "$f" ] || continue
